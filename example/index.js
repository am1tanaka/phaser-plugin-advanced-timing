...
(function() {
  "use strict";
  var BUNNIES_PER_EMIT, BUNNY_INTERVAL, BUNNY_LIFESPAN, CONFIG_HEIGHT, CONFIG_WIDTH, Phaser, SECOND, dat, debugSettings, debugSettingsGui, emitterGui, gameGui, gameScaleGui, gameTimeGui, pluginGui;
  ...
  this.GAME = new Phaser.Game({
    ...
    state: {
      ...
      create: function() {
        ...
        emitter = this.emitter = this.add.emitter(world.bounds.left, CONFIG_HEIGHT / 4, BUNNY_COUNT);
      ...
      render: function() {
        ...
        debug.text("Alive / Dead:" + this.emitter.countLiving() + " / " + this.emitter.countDead(), 0, 30);
      },
      shutdown: function() {
        this.gui.destroy();
      },
      emitterMakeBunnies: function() {
        this.makeParticles("bunny", null, this.maxParticles, false, true);
      }
    }
  });
